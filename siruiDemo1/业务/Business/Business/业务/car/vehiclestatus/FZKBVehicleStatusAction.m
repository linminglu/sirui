...
#import "FZKBVehicleStatusAction.h"
...
@implementation FZKBVehicleStatusAction
...
- (void)progress:(FZKActionResult *)result
{
    if(result.paramters[@"entity"]){
        ...
        FZKBVehicleStatusInfoModel *model = [FZKBVehicleStatusInfoModel mj_objectWithKeyValues:result.paramters[@"entity"]];
        [model archive];
 ...
 */
+ (void)vehicleStatusActionWithVehicleID:(NSInteger)vehicleID success:(Action1)success fail:(Action1)fail
{
    FZKBVehicleStatusAction *work =[[FZKBVehicleStatusAction alloc] init];
    

    [work vehicleStatusActionWithVehicleID:@(vehicleID).stringValue];
