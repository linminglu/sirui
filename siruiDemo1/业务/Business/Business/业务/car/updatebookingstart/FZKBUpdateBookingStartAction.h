...
//
//  FZKBUpdateBookingStartAction.h
//
//
...
#import <Connector/FZKBUpdateBookingStartHttpAction.h>

@interface FZKBUpdateBookingStartAction : FZKBUpdateBookingStartHttpAction
