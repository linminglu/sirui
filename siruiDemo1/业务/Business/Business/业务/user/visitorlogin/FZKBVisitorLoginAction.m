...
#import "FZKBVisitorLoginAction.h"
#import <SVProgressHUD.h>
#import "SRInterceptorUtil.h"

@implementation FZKBVisitorLoginAction
 ...
 */
+ (void)visitorLoginActionWithInput1:(NSString *)input1 input2:(NSString *)input2 success:(Action1)success fail:(Action1)fail
{
    FZKBVisitorLoginAction *work =[[FZKBVisitorLoginAction alloc] init];
    

    [work visitorLoginActionWithInput1:input1 input2:input2];
