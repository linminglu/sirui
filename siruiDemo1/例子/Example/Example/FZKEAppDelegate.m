...
#import "FZKEAppDelegate.h"
//#import <FZKCommons/FZKCommons.h>
//#import <FZKCommons/FZKCommons.h>
#import <Commons/FZKCRegisterCommonsAppkey.h>


@interface FZKEAppDelegate ()<UNUserNotificationCenterDelegate,WXApiDelegate>

@end

@implementation FZKEAppDelegate



- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    // Override point for customization after application launch.
    [FZKCRegisterCommonsAppkey registerCommonsAppkeyAppDelegateAndMessageReceive:self sendNotificationAck:launchOptions getIpBlock:^(NSString *ip) {
        NSLog(@"ip:%@",ip);
    }];
...
- (BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation
{
    ...
    return  [FZKCPayManager getPayResult:url appDelegate:self];
}
