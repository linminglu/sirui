...
//    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(getPayResult:) name:@"payResultCenter" object:nil];
...
//    notification.object =
    [[NSNotificationCenter defaultCenter]removeObserver:self name:@"payResultCenter" object:nil];
}
