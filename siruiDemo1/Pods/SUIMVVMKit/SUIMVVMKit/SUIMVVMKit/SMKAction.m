...
//        _sessionManager.responseSerializer.acceptableContentTypes =  [NSSet setWithObjects:@"application/json", @"text/json", @"text/javascript", @"text/html", @"text/plain",nil];
        ...
        _sessionManager.requestSerializer.timeoutInterval = (!self.timeoutInterval ?30: self.timeoutInterval);
...
- (NSDictionary *)requestObject:(id)request {
    ...
    if (requestObject.smk_url.length) {
        ...
        host = (self.host.length > 0 && requestObject.smk_host==nil)  ? self.host : requestObject.smk_host;
