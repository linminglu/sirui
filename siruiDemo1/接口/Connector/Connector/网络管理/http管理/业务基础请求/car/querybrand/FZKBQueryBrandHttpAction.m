...
#import "FZKBQueryBrandHttpAction.h"


@implementation FZKBQueryBrandHttpAction


//- (NSString *) getUrlString{
//
//    return [NSString stringWithFormat:@"%@/basic/brand/query",KBaseUrl];
//}
...
{
    [self addPara:@"pageIndex" withValue:@"1"];
    [self addPara:@"pageSize" withValue:@"1000"];
...
- (void)smk_requestConfigures
{
    ...
    self.smk_path = @"/basic/brand/query";
