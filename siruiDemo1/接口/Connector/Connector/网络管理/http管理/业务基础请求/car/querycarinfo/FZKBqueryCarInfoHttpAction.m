...
#import "FZKBqueryCarInfoHttpAction.h"


@implementation FZKBqueryCarInfoHttpAction


//- (NSString *) getUrlString{
//
//    return [NSString stringWithFormat:@"%@/basic/car/infos",KBaseUrl];
//}
