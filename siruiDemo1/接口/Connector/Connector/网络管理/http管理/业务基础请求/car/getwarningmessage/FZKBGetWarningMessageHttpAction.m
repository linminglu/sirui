...
//
//  FZKBGetWarningMessageHttpAction.m
//  Connector
//
...
#import "FZKBGetWarningMessageHttpAction.h"


@implementation FZKBGetWarningMessageHttpAction


//- (NSString *) getUrlString{
//
//    return [NSString stringWithFormat:@"%@/msg/msgList/getListByType",KBaseUrl];
//}
...
- (void)smk_requestConfigures
{
    ...
    self.smk_path = @"/msg/msgList/getListByType";
